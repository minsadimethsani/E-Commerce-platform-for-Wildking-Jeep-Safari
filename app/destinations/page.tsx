                  ...
                  <div className="lg:col-span-6 p-6 sm:p-8 flex flex-col justify-between space-y-6">
                      ...
                      <div className="space-y-2 pt-1">
                        ...
                        <div className="flex flex-wrap gap-1.5">
                          {park.primarySpecies.map((species, idx) => (
                            <span
                              key={idx}
                              className="px-3 py-1 rounded-lg bg-emerald-950/80 border border-emerald-800/60 text-xs font-semibold text-emerald-300"
                            >
                              🐾 {species}
                            </span>
                          ))}
                    ...
                    <div className="pt-4 border-t border-slate-800/80 flex items-center justify-between gap-4">
                      <a
                        ...
                        className="px-6 py-3 rounded-xl bg-amber-500/15 border border-amber-500/40 text-amber-300 text-xs font-bold hover:bg-amber-500/25 transition-all flex items-center gap-2"
                      >
                        <span>Explore {park.name.split(' ')[0]} Tours</span>
